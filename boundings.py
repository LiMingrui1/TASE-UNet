...
# training set
patient_info_path = r'F:\DATA\hecktor2022\hecktor2022_clinical_info_training.csv'
pet_path = 'F:/DATA/hecktor2022/imagesTr/'
bb_save_path = r'F:\DATA\hecktor2022\bb_box_training1.csv'
'''
# testing set
